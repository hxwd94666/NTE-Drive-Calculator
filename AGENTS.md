...
- 当前 schema：发行静态 v27、公共共享 v2、账号私有 v36。升级时同步常量、追加迁移、测试和本文件。
...
自动候选仅含当前/下一轨外、争锋全部八个挑战对象、四类材料养成副本和异象追猎单 Boss；不含异象巡礼或普通
大世界怪群。争锋命中后生命档按实测值，攻击及各抗性类目默认最高档且允许用户修改。每场战报最多保存一份
