...
from tools.game_data.build_graduation_templates import extra_shape_drive_count
from tools.game_data.build_graduation_templates import top_stat_names
...
class GraduationTemplateShapeBonusTests(unittest.TestCase):
    ...
    def test_missing_shape_rule_has_no_bonus_modules(self) -> None:
        self.assertEqual(
            0,
            extra_shape_drive_count({}, {"module_item_ids": ("two",)}, {"two": {"grid_count": 2}}),
        )
