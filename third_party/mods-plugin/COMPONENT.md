...
- 当前二进制：上游正式发布 `v0.4.1-build-137-385f5de` 中的 Windows x64 插件
- 工作区元数据版本：`0.3.6`（来自 `workspace/mods-plugin.version`）
- `bin/dwmapi.dll` SHA-256：`6D5A4B2C48BBEE97C6463BCA36AA2E3B2AA00849991EA6F0DDF7A0F28C76F133`
...
- 上游发布标签：`v0.4.1-build-137-385f5de`
